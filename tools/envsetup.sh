...
# This script exports the env variable MASSCALCULATOR_CLI_SOURCE, pointing at the 
...
MASSCALCULATOR_CLI_SOURCE="$(dirname "$(dirname "$(realpath "${BASH_SOURCE}")")")" > /dev/null
export MASSCALCULATOR_CLI_SOURCE
